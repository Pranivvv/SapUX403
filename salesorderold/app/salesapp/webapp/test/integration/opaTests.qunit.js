...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "salesapp/salesapp/test/integration/FirstJourney",
    "salesapp/salesapp/test/integration/SalesOrdersListJourney",
    "salesapp/salesapp/test/integration/SalesOrdersObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
