...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "employeedetails/employeedetails/test/integration/FirstJourney",
    "employeedetails/employeedetails/test/integration/employeeListJourney",
    "employeedetails/employeedetails/test/integration/employeeObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
